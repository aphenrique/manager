defmodule ManagerWeb.AccountControllerTest do
  use ManagerWeb.ConnCase

  import Manager.AccountsFixtures

  @create_attrs %{name: "some name", type: "some type", balance: 42}
  @update_attrs %{name: "some updated name", type: "some updated type", balance: 43}
  @invalid_attrs %{name: nil, type: nil, balance: nil}
