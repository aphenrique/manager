...
#
#     PHX_SERVER=true bin/manager start
#
...
if telegram_token = System.get_env("TELEGRAM_BOT_TOKEN") do
  config :manager, :telegram_token, telegram_token
...
if config_env() == :prod do
  database_path =
    System.get_env("DATABASE_PATH") ||
      ...
      For example: /etc/manager/manager.db
      """
  ...
  config :manager, :dns_cluster_query, System.get_env("DNS_CLUSTER_QUERY")
